...
############################
# Build entservices-displayinfo
echo "buliding entservices-displayinfo"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-displayinfo \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-displayinfo --target install
echo "======================================================================================"
exit 0
